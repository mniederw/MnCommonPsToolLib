...
Write-Output "Show GetTempPath()     = $([System.IO.Path]::GetTempPath())";               # "/tmp/", "C:\Users\myuser\AppData\Local\Temp"
Write-Output "Show Env:TmpDir        = $($env:TMPDIR)";                                   # ""
Write-Output "Show CurrentDir        = `"$PWD`"";                                         # Local-Win10   : "D:\mywork\MyOwner\MyRepo"
                                                                                          # Github-Windows: "D:\a\MyRepo\MyRepo"
                                                                                          # Github-ubuntu : "/home/runner/work/MnCommonPsToolLib/MnCommonPsToolLib"
Write-Output "Show GITHUB_WORKSPACE  = `"$($env:GITHUB_WORKSPACE)`"";                     # Local-Win10   : ""
                                                                                          # Github-Windows: "D:\a\MyRepo\MyRepo"
                                                                                          # Github-ubuntu : "/home/runner/work/MnCommonPsToolLib/MnCommonPsToolLib"
...
#Push-Location $PSScriptRoot;
  ...
  OutProgress "Show OsPsVersion             : $(OsPsVersion)"; # "7.4"
  OutProgress "Show Powershell Version      : V$($Host.Version.ToString())";
  ...
  OutInfo ("-"*86);
  OutSuccess "Ok, UnitTest was successful!";
