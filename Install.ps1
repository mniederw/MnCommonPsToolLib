...
OutProgress     "  (*) If you just switched install mode, before using these commands you probably ";
OutProgress     "      need to restart your calling shell or calling program (ex: a file manager) ";
OutProgress     "      because it still references the previous installed module. ";
