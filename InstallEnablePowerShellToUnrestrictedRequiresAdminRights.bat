...
ECHO   Restricted   - No scripts can be run. Windows PowerShell can be used only in interactive mode.
...
ECHO.
ECHO Note: In any mode a script can always be run with:  PowerShell.exe -ExecutionPolicy Unrestricted -NoProfile -File "myfile.ps1"
