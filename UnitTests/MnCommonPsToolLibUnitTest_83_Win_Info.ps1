...
function UnitTest_Win_Info(){
  ...
  #
  OutProgressTitle "InfoGetInstalledDotNetFxVersion";
  InfoGetInstalledDotNetFxVersion; # to console not output: "4.7.2 or later (533325)"
  if( (ProcessFindExecutableInPath "clrver.exe") -ne "" ){
    InfoGetInstalledDotNetFxVersion $true;
