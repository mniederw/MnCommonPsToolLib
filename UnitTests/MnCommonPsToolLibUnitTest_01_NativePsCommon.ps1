...
Write-Output "Show GetTempPath()     = $([System.IO.Path]::GetTempPath())";               # Example: "/tmp/", "$HOME\AppData\Local\Temp"
...
$($env:PSModulePath).Split($pathSep) | Where-Object{ $null -ne $_ } | ForEach-Object{
  ...
  # Local-Win10   : ";$HOME\Documents\WindowsPowerShell\Modules"
  ...
  #                 ";$env:ProgramFiles\VisualSvn VisualSvn Server\PowerShellModules"
  ...
  #                 ";$env:ProgramFiles\WindowsPowerShell\Modules"
  #                 ";$env:SystemRoot\System32\WindowsPowerShell\v1.0\Modules"
  #                 ";$env:ProgramFiles\Microsoft SQL Server\130\Tools\PowerShell\Modules\"
  #                 ";${env:ProgramFiles(x86)}\Google\Cloud SDK\google-cloud-sdk\platform\PowerShell"
