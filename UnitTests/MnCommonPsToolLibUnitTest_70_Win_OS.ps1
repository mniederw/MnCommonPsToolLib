...
function UnitTest_Win_OS(){
  ...
  Assert (FsEntryGetAbsolutePath $UserQuickLaunchDir.StartsWith("C:\"));
  Assert (FsEntryGetAbsolutePath      $UserSendToDir.StartsWith("C:\"));
  Assert (FsEntryGetAbsolutePath        $UserMenuDir.StartsWith("C:\"));
  Assert (FsEntryGetAbsolutePath $UserMenuStartupDir.StartsWith("C:\"));
  Assert (FsEntryGetAbsolutePath    $AllUsersMenuDir.StartsWith("C:\"));
  #
  Assert (OsIs64BitOs);
